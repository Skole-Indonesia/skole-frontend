...
const MasukDewantaraMuda = () => {
  ...
  const handleLogin = (e) => {
    ...
    if (
      email === "dewantaramuda@gmail.com" &&
      password === "DewantaraMuda12345"
    ) {
      // Store ROLE in localStorage
      localStorage.setItem("ROLE", "dewantara-muda");
      // Redirect to /mardika/dashboard
      // history.push("/mardika/dashboard");
      setTimeout(() => {
        // navigate("/dewantara-muda/dashboard");
        // window.location.href = "/dewantara-muda/kelompok";
...
export default MasukDewantaraMuda;
