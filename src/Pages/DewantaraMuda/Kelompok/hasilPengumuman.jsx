                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="card border border-gray-300 rounded-xl p-6">
                    ...
                    <div className="flex gap-4 mt-4 flex-col">
                      <div className="flex gap-4 items-center mt-4">
                        <p className="text-slate-600">
                          Selamat datang para Mardika-ku! Yuk kita kumpul nanti
                          jam 5 sore di Masjid
                        </p>
                      </div>
                      <button
                        onClick={openModal}
                      ...
                      <button
                        onClick={openModal}
                        className="bg-red-50 px-4 py-3 rounded-md text-red-600 font-medium hover:bg-red-600 hover:text-white transition-all delay-200 "
                      >
                        Hapus Pengumuman
                      </button>
                    </div>
